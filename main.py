...
import validators # Import the validators package #type: ignore
...
def main():
    ...
    parser.add_argument('--url', help='The URL to encode in the QR code', default='https://github.com/xsylvers')
